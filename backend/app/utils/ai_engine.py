...
# ============================================
TU_KHOA_VI_PHAM = [
    # Nhóm Ngôn từ thô tục (Các mục cũ đã TỐT - Không sửa)
    ...
    # Nhóm Bạo lực
    { "nhom": "Bạo lực", "tu_khoa": "đánh chết", "regex": r"(?:\s|^)đánh\schết(?:\s|$|\.|\!|\?)" },
    { "nhom": "Bạo lực", "tu_khoa": "chém", "regex": r"(?:\s|^)chém(?:\s|$|\.|\!|\?)" },
    { "nhom": "Bạo lực", "tu_khoa": "giết", "regex": r"(?:\s|^)giết(?:\s|$|\.|\!|\?)" },
    { "nhom": "Bạo lực", "tu_khoa": "đâm", "regex": r"(?:\s|^)đâm(?:\s|$|\.|\!|\?)" },
    { "nhom": "Bạo lực", "tu_khoa": "xử đẹp", "regex": r"(?:\s|^)xử\sđẹp(?:\s|$|\.|\!|\?)" },
    { "nhom": "Bạo lực", "tu_khoa": "đập đầu", "regex": r"(?:\s|^)đập\sđầu(?:\s|$|\.|\!|\?)" },
    { "nhom": "Bạo lực", "tu_khoa": "bắn súng", "regex": r"(?:\s|^)bắn\ssúng(?:\s|$|\.|\!|\?)" },
    { "nhom": "Bạo lực", "tu_khoa": "nổ bom", "regex": r"(?:\s|^)nổ\sbom(?:\s|$|\.|\!|\?)" },
    { "nhom": "Bạo lực", "tu_khoa": "đốt xác", "regex": r"(?:\s|^)đốt\sxác(?:\s|$|\.|\!|\?)" },
    { "nhom": "Bạo lực", "tu_khoa": "hành hạ", "regex": r"(?:\s|^)hành\shạ(?:\s|$|\.|\!|\?)" },
    { "nhom": "Bạo lực", "tu_khoa": "cưỡng bức", "regex": r"(?:\s|^)cưỡng\sbức(?:\s|$|\.|\!|\?)" },
    { "nhom": "Bạo lực", "tu_khoa": "tra tấn", "regex": r"(?:\s|^)tra\stấn(?:\s|$|\.|\!|\?)" },
    ...
    { "nhom": "Khiêu dâm", "tu_khoa": "hiếp", "regex": r"(?:\s|^)hiếp(?:\s|$|\.|\!|\?)" },
    ...
    { "nhom": "Khiêu dâm", "tu_khoa": "cực khoái", "regex": r"(?:\s|^)cực\skhoái(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "lên đỉnh", "regex": r"(?:\s|^)lên\sđỉnh(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "phim nóng", "regex": r"(?:\s|^)phim\snóng(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "18+", "regex": r"(?:\s|^)18\+(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "địt nhau", "regex": r"(?:\s|^)địt\snhau(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "porn", "regex": r"(?:\s|^)porn(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "rape", "regex": r"(?:\s|^)rape(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "blowjob", "regex": r"(?:\s|^)blowjob(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "handjob", "regex": r"(?:\s|^)handjob(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "oral sex", "regex": r"(?:\s|^)oral\ssex(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "gangbang", "regex": r"(?:\s|^)gangbang(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "sờ mó", "regex": r"(?:\s|^)sờ\smó(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "liếm", "regex": r"(?:\s|^)liếm(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "kích dục", "regex": r"(?:\s|^)kích\sdục(?:\s|$|\.|\!|\?)" },
    { "nhom": "Khiêu dâm", "tu_khoa": "lộ hàng", "regex": r"(?:\s|^)lộ\shàng(?:\s|$|\.|\!|\?)" },
    ...
    { "nhom": "Phân biệt giới tính", "tu_khoa": "đàn ông mới là trụ cột", "regex": r"(?:\s|^)đàn\sông\smới\slà\strụ\scột(?:\s|$|\.|\!|\?)" },
    { "nhom": "Phân biệt giới tính", "tu_khoa": "chỉ có đàn ông mới làm được việc lớn", "regex": r"(?:\s|^)chỉ\scó\sđàn\sông\smới\slàm\sđược\sviệc\slớn(?:\s|$|\.|\!|\?)" },
    ...
    { "nhom": "Phân biệt chủng tộc", "tu_khoa": "người da vàng kém thông minh", "regex": r"(?:\s|^)người\sda\svàng\ském\sthông\sminh(?:\s|$|\.|\!|\!|\?)" },
    { "nhom": "Phân biệt chủng tộc", "tu_khoa": "dân châu Phi bẩn", "regex": r"(?:\s|^)dân\schâu\sPhi\sbẩn(?:\s|$|\.|\!|\?)" },
    ...
    { "nhom": "Phân biệt tôn giáo", "tu_khoa": "bài Do Thái", "regex": r"(?:\s|^)bài\sDo\sThái(?:\s|$|\.|\!|\?)" },
    { "nhom": "Phân biệt tôn giáo", "tu_khoa": "Phật giáo là mê tín", "regex": r"(?:\s|^)Phật\sgiáo\slà\smê\stín(?:\s|$|\.|\!|\?)" },
    { "nhom": "Phân biệt tôn giáo", "tu_khoa": "Thiên Chúa là lừa đảo", "regex": r"(?:\s|^)Thiên\sChúa\slà\slừa\sđảo(?:\s|$|\.|\!|\?)" },
    { "nhom": "Phân biệt tôn giáo", "tu_khoa": "mỉa mai người theo đạo", "regex": r"(?:\s|^)mỉa\smai\sngười\stheo\sđạo(?:\s|$|\.|\!|\?)" },
    { "nhom": "Phân biệt tôn giáo", "tu_khoa": "xúc phạm giáo lý", "regex": r"(?:\s|^)xúc\sphạm\sgiáo\slý(?:\s|$|\.|\!|\?)" },
    
    # Nhóm Lừa đảo, gian lận
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "hack tài khoản", "regex": r"(?:\s|^)hack\stài\skhoản(?:\s|$|\.|\!|\?)" },
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "tạo thẻ tín dụng giả", "regex": r"(?:\s|^)tạo\sthẻ\stín\sdụng\sgiả(?:\s|$|\.|\!|\?)" },
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "bypass OTP", "regex": r"(?:\s|^)bypass\sOTP(?:\s|$|\.|\!|\?)" },
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "DDoS", "regex": r"(?:\s|^)DDoS(?:\s|$|\.|\!|\?)" },
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "spam SMS", "regex": r"(?:\s|^)spam\sSMS(?:\s|$|\.|\!|\?)" },
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "mã độc", "regex": r"(?:\s|^)mã\sđộc(?:\s|$|\.|\!|\?)" },
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "phishing", "regex": r"(?:\s|^)phishing(?:\s|$|\.|\!|\?)" },
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "fake ID", "regex": r"(?:\s|^)fake\sID(?:\s|$|\.|\!|\?)" },
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "chiếm đoạt tài sản", "regex": r"(?:\s|^)chiếm\sđoạt\stài\ssản(?:\s|$|\.|\!|\?)" },
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "trúng thưởng giả", "regex": r"(?:\s|^)trúng\sthưởng\sgiả(?:\s|$|\.|\!|\?)" },
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "giả làm công an", "regex": r"(?:\s|^)giả\slàm\scông\san(?:\s|$|\.|\!|\?)" },
    { "nhom": "Lừa đảo, gian lận", "tu_khoa": "nhà đầu tư", "regex": r"(?:\s|^)nhà\sđầu\stư(?:\s|$|\.|\!|\?)" },
    
    # Nhóm Sai lệch y tế
    { "nhom": "Sai lệch y tế", "tu_khoa": "chữa ung thư bằng lá đu đủ", "regex": r"(?:\s|^)chữa\sung\sthư\sbằng\slá\sđu\sđủ(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch y tế", "tu_khoa": "không cần tiêm vaccine", "regex": r"(?:\s|^)không\scần\stiêm\svaccine(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch y tế", "tu_khoa": "uống nước muối chữa COVID", "regex": r"(?:\s|^)uống\snước\smuối\schữa\sCOVID(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch y tế", "tu_khoa": "bỏ thuốc tây", "regex": r"(?:\s|^)bỏ\sthốc\stây(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch y tế", "tu_khoa": "ăn chay trị HIV", "regex": r"(?:\s|^)ăn\schay\strị\sHIV(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch y tế", "tu_khoa": "dùng đá lạnh để ngưng tim", "regex": r"(?:\s|^)dùng\sđá\slạnh\sđể\sngưng\stim(?:\s|$|\.|\!|\?)" },
    
    # Nhóm Sai lệch pháp lý
    { "nhom": "Sai lệch pháp lý", "tu_khoa": "ký tên giả", "regex": r"(?:\s|^)ký\stên\sgiả(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch pháp lý", "tu_khoa": "ly hôn cứ bỏ nhà", "regex": r"(?:\s|^)ly\shôn\scứ\sbỏ\snhà(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch pháp lý", "tu_khoa": "không cần hợp đồng", "regex": r"(?:\s|^)không\scần\shợp\sđồng(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch pháp lý", "tu_khoa": "đánh người không sao nếu không có bằng chứng", "regex": r"(?:\s|^)đánh\sngười\skhông\ssao\snếu\skhông\scó\sbằng\schứng(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch pháp lý", "tu_khoa": "giả chữ ký thoải mái", "regex": r"(?:\s|^)giả\schữ\ský\sthoải\smái(?:\s|$|\.|\!|\?)" },
    
    # Nhóm Sai lệch trong giáo dục
    { "nhom": "Sai lệch trong giáo dục", "tu_khoa": "thầy cô ngu", "regex": r"(?:\s|^)thầy\scô\sngu(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch trong giáo dục", "tu_khoa": "giáo viên ăn lương mà không làm gì", "regex": r"(?:\s|^)giáo\sviên\săn\slương\smà\skhông\slàm\sgì(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch trong giáo dục", "tu_khoa": "bỏ học vẫn thành công", "regex": r"(?:\s|^)bỏ\shọc\svẫn\sthành\scông(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch trong giáo dục", "tu_khoa": "trường học vô dụng", "regex": r"(?:\s|^)trường\shọc\svô\sdụng(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch trong giáo dục", "tu_khoa": "chửi thầy cô", "regex": r"(?:\s|^)chửi\sthầy\scô(?:\s|$|\.|\!|\?)" },
    { "nhom": "Sai lệch trong giáo dục", "tu_khoa": "đánh giáo viên", "regex": r"(?:\s|^)đánh\sgiáo\sviên(?:\s|$|\.|\!|\?)" }
]
...
TU_KHOA_KHUNG_HOANG = [
    ...
    { "nhom": "tu_tu", "tu_khoa": "check out", "regex": r"(?:\s|^)check\sout(?:\s|$|\.|\!|\?)" },
    { "nhom": "tu_tu", "tu_khoa": "đăng xuất", "regex": r"(?:\s|^)đăng\sxuất(?:\s|$|\.|\!|\?)" },
    ...
    { "nhom": "tu_lam_hai", "tu_khoa": "đau khổ quá", "regex": r"(?:\s|^)đau\skhổ\squá(?:\s|$|\.|\!|\?)" },
    ...
    # Nhóm Bạo lực
    { "nhom": "bao_luc", "tu_khoa": "bị đánh đập", "regex": r"(?:\s|^)bị\sđánh\sđập(?:\s|$|\.|\!|\?)" },
    { "nhom": "bao_luc", "tu_khoa": "bạo lực gia đình", "regex": r"(?:\s|^)bạo\slực\sgia\sđình(?:\s|$|\.|\!|\?)" },
    { "nhom": "bao_luc", "tu_khoa": "xâm hại", "regex": r"(?:\s|^)xâm\shại(?:\s|$|\.|\!|\?)" },
    { "nhom": "bao_luc", "tu_khoa": "bạo lực", "regex": r"(?:\s|^)bạo\slực(?:\s|$|\.|\!|\?)" },
    # Đây là mục đã được sửa trong câu trả lời trước
    { "nhom": "bao_luc", "tu_khoa": "quấy rối tình dục", "regex": r"(?:\s|^)quấy\srối\stình\sdục(?:\s|$|\.|\!|\?)" },
    { "nhom": "bao_luc", "tu_khoa": "hiếp dâm", "regex": r"(?:\s|^)hiếp\sdâm(?:\s|$|\.|\!|\?)" },
    { "nhom": "bao_luc", "tu_khoa": "cưỡng bức", "regex": r"(?:\s|^)cưỡng\sbức(?:\s|$|\.|\!|\?)" },
    { "nhom": "bao_luc", "tu_khoa": "lạm dụng tình dục", "regex": r"(?:\s|^)lạm\sdụng\stình\sdục(?:\s|$|\.|\!|\?)" }
]
